...
// to store classes by their name
...
// to store methods by their name
...
// install classes into classTable
...
// install methods into methodTable
...
// get inheritance by class itself
...
// to conform whether name1 is subtype name2 or not
...
// to find least common ancestor of name1 and name2
...
// to return a method by it's name
...
// to check whether we have a cycle or not
...
// to check whether we have main class and main method or not
...
// to check method and it's types
...
Symbol block_class::checkType() {
    // type of block is type of last one
